...
from firewall.tools import export_user_firewall, generate_firewall_footer, generate_firewall_header, \
    generate_port_forward_firewall, generate_redirect_dns_rules, generate_redirect_nginx_rules, generate_route_policy_rules
...
def export_firewall_configuration():
    ...
    firewall_content += generate_redirect_nginx_rules()
